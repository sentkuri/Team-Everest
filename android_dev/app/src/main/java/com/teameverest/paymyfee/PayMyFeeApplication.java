...
public class PayMyFeeApplication extends android.app.Application {
    ...
    public static final String TAG = PayMyFeeApplication.class.getSimpleName();

    private static PayMyFeeApplication mInstance;
...
*/
    ...
    public static synchronized PayMyFeeApplication getInstance() {
        return mInstance;
    }
